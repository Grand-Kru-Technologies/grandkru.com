<template>
  <div class="min-h-screen pt-24 pb-12 bg-gray-50 dark:bg-dark-bg transition-colors duration-300">
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row items-center justify-between gap-8">
        <div class="md:w-1/2">
          <div class="bg-white dark:bg-dark-surface rounded-2xl p-8 md:p-12 shadow-xl dark:shadow-2xl">
            <h1 class="text-3xl md:text-4xl font-bold mb-4 text-center md:text-left">
